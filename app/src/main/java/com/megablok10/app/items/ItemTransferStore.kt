 ...
 * Карточку по сети доставляет сценарий SendItem, чек отправителю шлёт AcceptItem — журнал с сетью не работает.
 */
class ItemTransferStore(
    ...
    override fun observeAll(): Flow<List<ItemTransferEntity>> = dao.observeAll()
